'''
application shows how different clicks are bind
buttons responds differently to different mouse clicks
some of the clicks display event address showing different events 
'''
